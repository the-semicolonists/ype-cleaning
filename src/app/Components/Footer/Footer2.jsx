          ...
          <ul className="cs_footer_contact_info_list cs_mp_0">
            <li>
              ...
              <div className="">
                ...
                <p className="mb-0 cs_white_color">
                  <a href="mailto:+(163)-5565-06979">+(163)-5565-06979</a>
                </p>
              </div>
            </li>
            <li>
            ...
            <div className="cs_footer_col">
              <div className="cs_footer_widget">
                <div className="cs_text_widget">
                  ...
                  <p>
                    Phosfluorescently transform out-of-the-box paradigms whereas accurate supply
                    chains. Continually
                  </p>
                </div>
              ...
              <div className="cs_footer_widget">
                ...
                <ul className="cs_footer_contact_list cs_mp_0">
                  ...
                  <li>
                    ...
                    <a href="mailto:ype@gmail.com">ype@gmail.com</a>
                  </li>
                </ul>
              </div>
            </div>
                  ...
                  <li>
                    <div className="cs_recent_post">
                      ...
                      <div className="cs_recent_post_right">
                        ...
                        <p className="cs_recent_posted_by cs_fs_14">
                          <i className="bi bi-calendar-fill"></i>10 May, 2024
                        </p>
                      </div>
                    </div>
                  </li>
        ...
        <div className="container">
          <div className="cs_footer_bottom_in">
            <div className="cs_footer_copyright">
              Copyright © 2024 <a href="#">ype</a>. All Rights Reserved.
            </div>
            <div>
