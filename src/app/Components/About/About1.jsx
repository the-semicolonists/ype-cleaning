          ...
          <div className="col-xl-6">
            <div className="cs_about_thumbnail_wrapper position-relative">
              ...
              <div className="cs_about_shape_2 position-absolute">
                <Image src="/assets/img/shapes/gear_1.svg" alt="img" width={274} height={274} />
              </div>
            </div>
          </div>
          <div className="col-xl-6">
              ...
              <div className="cs_features_list cs_mb_32">
                <div className="cs_iconbox cs_style_1">
                  <div className="cs_iconbox_icon cs_center">
                    <Image src="/assets/img/icons/quick-fix.svg" alt="img" width={49} height={53} />
                  </div>
                  <h3 className="cs_iconbox_title cs_fs_24 cs_semibold mb-0">{feature1}</h3>
                </div>
                <div className="cs_iconbox cs_style_1">
                  <div className="cs_iconbox_icon cs_center">
                    <Image src="/assets/img/icons/quick-fix.svg" alt="img" width={37} height={40} />
                  </div>
