        ...
        <div className="row cs_row_gap_60 cs_gap_y_30">
          ...
          <div className="col-lg-6">
            <div className="cs_team_details_content">
              ...
              <p className="cs_team_details_text cs_mb_25">
                The duration of a project depends on its scope and complexity. We provide a detailed
                timeline after the initial consultation The duration of a project depends on its
                scope and complexity. We provide a detailed
              </p>
