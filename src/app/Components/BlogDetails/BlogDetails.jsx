        ...
        <div className="row cs_row_gap_30 cs_gap_y_60">
          <div className="col-xl-8 col-lg-7">
            <div className="cs_post_details">
              ...
              <p>
                Visit our shop as soon as possible for a diagnostic test to determine the issue
                sounds, longer stopping distances, or a soft brake pedal are common signs that your
                brakes need attention engine crank, dim lights, and needing frequent jump starts are
                typical signs that your battery may need replacement.
              </p>
              <p>
                Repair times vary depending on the service, but most standard repairs are completed
                within a few hours provide a detailed estimate before any work begins.
              </p>
              <blockquote>
              ...
              <p>
                Repair times vary depending on the service. We provide estimates before work begins
                we offer a [specific time frame kinds warranty on parts and labor for most services
                service all makes and models, including both domestic and foreign vehicles we accept
                walk-ins, scheduling an appointment ensures faster service.
              </p>
              <p>
                We service all makes and models, including both domestic and foreign vehicles
                standard repairs can be completed any within a day, but it varies depending on the
                complexity.
              </p>
              <div className="row">
              ...
              <p>
                You can get an estimate by visiting our shop, calling us, or filling out the online
                form with details about your car’s issue we offer emergency repair services to get
                you back on the road as quickly as possible we offer a warranty on all parts and
                kind labor to ensure your peace of mind.
              </p>
            </div>
            <div className="cs_post_share_wrapper">
              <div className="cs_post_tags cs_style_1">
                ...
                <div className="cs_tags_links cs_fs_14 cs_semibold cs_heading_font">
                  <a href="#" className="cs_tag_link cs_accent_bg_light">
                    Services
                  </a>
                  <a href="#" className="cs_tag_link cs_accent_bg_light">
                    Auto Parts
              ...
              <ul className="cs_comment_list cs_heading_font cs_mp_0">
                <li className="cs_comment_body position-relative">
                  ...
                  <div className="cs_comment_info">
                    ...
                    <p className="mb-0">
                      Most repairs can be completed within a few hours, but complex issues might
                      take longer. We always aim a for same-day service when possible.
                    </p>
                    <a
                      href="#"
                ...
                <li className="cs_comment_body position-relative">
                  ...
                  <div className="cs_comment_info">
                    ...
                    <p className="mb-0">
                      We offer free estimates before any repairs begin, so you know exactly what to
                      expect on all part and labor, ensuring your peace of mind.
                    </p>
                    <a
                      href="#"
                      className="cs_reply_btn cs_heading_bg cs_fs_14 cs_bold cs_white_color text-uppercase"
                ...
                <li className="cs_comment_body position-relative">
                  ...
                  <div className="cs_comment_info">
                    ...
                    <p className="mb-0">
                      Tire rotation is typically recommended every 6,000 to 8,000 miles to ensure
                      even wear and extend the life of your tires more serious that needs attention.
                    </p>
                    <a
                      href="#"
                      className="cs_reply_btn cs_heading_bg cs_fs_14 cs_bold cs_white_color text-uppercase"
            ...
            <div className="cs_sidebar cs_style_1">
                  ...
                  <div className="cs_recent_post">
                    ...
                    <div className="cs_recent_post_right">
                      <p className="cs_recent_posted_by cs_fs_14">
                        <i className="bi bi-calendar-fill"></i>12 May, 2024
                      </p>
              ...
              <div className="cs_sidebar_widget cs_accent_bg_light position-relative">
                ...
                <div className="cs_sidebar_tags">
                  ...
                  <div className="cs_tags_links cs_fs_14 cs_semibold cs_heading_font">
                    <a href="#" className="cs_tag_link cs_white_bg">
                      Popular
                    </a>
                    <a href="#" className="cs_tag_link cs_white_bg">
                      Car
